...
function (Ash, PlayerActionData, ObjectUtils, GameConstants, CampConstants, ImprovementConstants) {
	...
	var PlayerActionConstants = {
		...
		DISABLED_REASON_LAUNCHED: "Đang rời khỏi hành tinh",
		DISABLED_REASON_LOCKED_RESOURCES: 'Cần những tài nguyên chưa được mở khóa.',
		...
		DISABLED_REASON_NOT_REACHABLE_BY_TRADERS: "Đoàn buôn không thể đến được trại.",
